...
define('DBUSERNAME','testdb');  // Replace root with your database username. If unsure, leave as is.
define('DBPASSWORD','testdb');	// Replace root with your database user password.
define('DBNAME','testdb'); 	//Create a new database qwench on your server and replace YOUR_DB with it's name
